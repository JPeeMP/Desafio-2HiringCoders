# Desafio-2HiringCoders - Gestão de Cadastros
...
- o botão cadastrar esta tem um evento de click que aciona a função onclick="cadastraCliente()" para os dados dos clientes, e onclick="cadastraProduto()" para produtos.
